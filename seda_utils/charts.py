...
from seda_visual import seda_plots
...
def show_charts(figs, plots_color, chart_titles, template):
    ...
    for fig in figs:
        if isinstance(fig, (list, tuple)):
            f = fig[0]
            seda_plots.fig_layout(template, f, chart_titles=chart_titles, plots_colorscale=plots_color)
            ...
            seda_plots.fig_layout(template, fig, chart_titles=chart_titles, plots_colorscale=plots_color)
