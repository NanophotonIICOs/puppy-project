...
% color 
\definecolor{puppycolor}{RGB}{137,216,190}

\titlespacing*{\chapter}{0cm}{-1.cm}{-40pt}%pbk
\titleformat{\chapter}[display]{\Huge\filleft\scshape}{\tikz{\draw[fill=puppycolor] (0,0) circle [radius=3cm] node[scale=5,font=\bfseries,white] {\thechapter}; }
...
\node[anchor=east,rectangle,rounded corners=7,draw,fill=puppycolor] at (0,0) (counter) {\color{white}\textbf{#2}};
...
\node[anchor=east,circle,draw,fill=puppycolor] at (0,0) (counter) {\color{white}\textbf{#2}};
